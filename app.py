...
st.write("Select your options across all 4 subjects, then click **Submit Entire Quiz** at the bottom to calculate your detailed score and view the answer key!")
        ...
        with tabs[i]:
            ...
            for idx, item in enumerate(questions):
                ...
                user_responses[f"{prefix}_{idx}"] = st.radio(
                    "Select option:", item["options"], key=f"{prefix}_radio_{idx}"
                )
                st.divider()
